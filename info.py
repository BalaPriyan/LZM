...
BOT_TOKEN = environ.get('BOT_TOKEN', "6616117296:AAEbqjSWzS6nLAhVKnN0nP549CUDN3QLnR0")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6697298553').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001971278560').split()]
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', "-1001971278560"))
...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', "-1001971278560"))
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','BalaPriyanB') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','TomenBots') # WITHOUT @
...
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "TomenLMGroup") #[ without @ ]
...
DOWNLOAD_TEXT_URL = "https://t.me/TomenBots"
